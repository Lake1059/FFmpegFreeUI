...
Public Class 预设数据_v6
    ...
    Public Property 视频参数_色彩管理_启用亮度调整 As Boolean = False
    Public Property 视频参数_色彩管理_亮度 As Single = 0
    Public Property 视频参数_色彩管理_启用对比度调整 As Boolean = False
    Public Property 视频参数_色彩管理_对比度 As Single = 1
    Public Property 视频参数_色彩管理_启用饱和度调整 As Boolean = False
    Public Property 视频参数_色彩管理_饱和度 As Single = 1
    Public Property 视频参数_色彩管理_启用伽马调整 As Boolean = False
    Public Property 视频参数_色彩管理_伽马 As Single = 1
    '==================================================
