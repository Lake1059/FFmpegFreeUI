...
Public Class 界面控制_添加文件
    ...
    Public Shared Sub 加入编码队列()
        ...
        Form1.准备文件页面.ListView1.Items.Clear()
    ...
    Public Shared Sub ListView2_DragDrop(sender As Object, e As DragEventArgs)
        ...
        For Each b As String In files
            ...
            Form1.准备文件页面.ListView1.Items.Add(New ListViewItem({路径, Format(FileLen(路径) / 1024 / 1024, "0") & " MB"}))
        Next
    End Sub
    ...
    Public Shared Sub 批量移除选中项()
        For Each a As ListViewItem In Form1.准备文件页面.ListView1.SelectedItems
            Form1.准备文件页面.ListView1.Items.Remove(a)
        Next
    End Sub
