...
Public Class 界面_设置
    ...
    Sub 调整界面()
        ...
        校准UiComboBox视觉(UiComboBox修正_选项卡文字增加左侧空格)
        校准UiComboBox视觉(UiComboBox修正_增加标签尺寸)
        校准UiComboBox视觉(UiComboBox修正_列表视图项高度)
        校准UiComboBox视觉(UiComboBox修正_编码队列列宽调整逻辑)
        校准UiComboBox视觉(UiComboBox自动开始最大任务数量)
        校准UiComboBox视觉(UiComboBox编码队列刷新速度)
        ...
        校准UiComboBox视觉(UiComboBox独立参数面板自动切换页面)
        校准UiComboBox视觉(UiComboBox任务失败自动删除输出文件)
        校准UiComboBox视觉(UiComboBox自动开始最大任务数量)
    ...
    Public Sub 初始化设置操作响应()
        ...
        AddHandler UiComboBox字体名称.TextChanged, Sub()
                                               ...
                                               End Sub
        AddHandler UiComboBox语言选择.SelectedIndexChanged, Sub()
                                                            Select Case UiComboBox语言选择.SelectedIndex
                                                                Case 0
                                                                    用户设置.实例对象.语言 = "zh"
                                                                Case 1
                                                                    用户设置.实例对象.语言 = "en"
                                                            End Select
                                                        End Sub
        AddHandler UiComboBox修正_选项卡文字增加左侧空格.SelectedIndexChanged, Sub()
                                                                      用户设置.实例对象.界面修正_选项卡文字增加左侧空格 = UiComboBox修正_选项卡文字增加左侧空格.Text
                                                                  End Sub
        AddHandler UiComboBox修正_增加标签尺寸.SelectedIndexChanged, Sub()
                                                                 用户设置.实例对象.界面修正_增加使用文字渲染尺寸来调节的标签的尺寸 = UiComboBox修正_增加标签尺寸.Text
                                                             End Sub
        AddHandler UiComboBox修正_列表视图项高度.SelectedIndexChanged, Sub()
                                                                  用户设置.实例对象.界面修正_校准列表视图的项高度 = UiComboBox修正_列表视图项高度.Text
                                                                  Form1.ImageList1.ImageSize = New Size(1, 30 * Form1.DPI + 用户设置.实例对象.界面修正_校准列表视图的项高度 * Form1.DPI)
                                                              End Sub
        AddHandler UiComboBox修正_编码队列列宽调整逻辑.SelectedIndexChanged, Sub()
                                                                     用户设置.实例对象.界面修正_编码队列的列宽调整逻辑 = UiComboBox修正_编码队列列宽调整逻辑.SelectedIndex
                                                                 End Sub
        ...
        AddHandler UiComboBox自动开始最大任务数量.SelectedIndexChanged, Sub()
                                                                  ...
                                                                  End Select
                                                              End Sub
        AddHandler UiComboBox编码队列刷新速度.SelectedIndexChanged, Sub()
                                                                用户设置.实例对象.编码队列刷新速度 = UiComboBox编码队列刷新速度.SelectedIndex
                                                                Select Case 用户设置.实例对象.编码队列刷新速度
