...
Partial Class FormMain_v6
    ...
    Private Sub InitializeComponent()
        ...
        ThisIsYourWindow1.CaptionButtonHoverBackColor = Color.FromArgb(CByte(80), CByte(80), CByte(80))
        ThisIsYourWindow1.CaptionButtonPressedBackColor = Color.FromArgb(CByte(120), CByte(120), CByte(120))
