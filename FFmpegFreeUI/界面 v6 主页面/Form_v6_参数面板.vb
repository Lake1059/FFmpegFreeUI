Public Class Form_v6_参数面板
    ...
    Public 私有界面_视频后处理 As New Form_v6_参数面板_视频后处理
    ...
    Private Sub Form_v6_参数面板_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.ModernTabListControl1.Items(10).BoundControl = 私有界面_视频后处理
        Me.ModernTabListControl1.Items(11).BoundControl = 私有界面_视频帧服务器
        '==================================================
        Me.ModernTabListControl1.Items(13).BoundControl = 私有界面_音频参数
        '==================================================
        Me.ModernTabListControl1.Items(15).BoundControl = 私有界面_剪辑区间
        Me.ModernTabListControl1.Items(16).BoundControl = 私有界面_滤镜排序
        Me.ModernTabListControl1.Items(17).BoundControl = 私有界面_自定义参数
        ...
        Me.ModernTabListControl1.Items(18).BoundControl = 私有界面_流控制
        '==================================================
        Me.ModernTabListControl1.Items(20).BoundControl = 私有界面_附加内容
