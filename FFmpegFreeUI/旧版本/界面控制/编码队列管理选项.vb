Public Class 编码队列管理选项
    ...
    Public Shared Sub 初始化()
        ...
        a.Items.AddRange(New ToolStripItem() {
                 ...
                 New ToolStripMenuItem("(可多选) 将任务  -->  放到准备文件选项卡", Nothing, AddressOf 界面控制_编码队列.将任务放到添加文件选项卡),
                 ...
                 New ToolStripMenuItem("选中所有出错任务并定位首个", Nothing, AddressOf 界面控制_编码队列.选中所有出错的任务),
                 New ToolStripMenuItem("置顶所有出错任务", Nothing, AddressOf 界面控制_编码队列.置顶已有的错误任务),
