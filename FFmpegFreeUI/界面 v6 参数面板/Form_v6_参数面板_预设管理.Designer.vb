...
Partial Class Form_v6_参数面板_预设管理
    ...
    Private Sub InitializeComponent()
        ...
        ' Panel3
        ' 
        Panel3.Controls.Add(ModernTextBox3)
        ...
        ModernCheckBox1.Size = New Size(144, 32)
        ModernCheckBox1.TabIndex = 14
        ModernCheckBox1.Text = "额外保存输出位置"
        ' 
        ' JustEmptyControl8
        ' 
        ...
        ' Panel4
        ' 
        Panel4.Controls.Add(ModernTextBox4)
