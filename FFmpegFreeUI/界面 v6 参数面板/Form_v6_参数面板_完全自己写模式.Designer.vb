...
Partial Class Form_v6_参数面板_完全自己写模式
    ...
    Private Sub InitializeComponent()
        ...
        HtmlColorLabel1.Text = "<span style=""font-size:13"">完全自己写</span>   <span style=""font-size:10pt; color:IndianRed"">使用此模式时，其他所有参数全都不生效！</span>"
        ' 
        ' ModernTextBox1
        ' 
        ...
        ModernTextBox1.Location = New Point(20, 163)
        ...
        ModernTextBox1.Size = New Size(770, 481)
