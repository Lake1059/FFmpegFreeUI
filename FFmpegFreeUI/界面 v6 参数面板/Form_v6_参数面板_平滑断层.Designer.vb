...
Partial Class Form_v6_参数面板_平滑断层
    ...
    Private Sub InitializeComponent()
        ...
        ModernPanel1.Controls.Add(MCK_平滑断层总开关)
        ...
        ' ETB_平滑断层参数4
        '
        ETB_平滑断层参数4.BackColor = Color.FromArgb(CByte(20), CByte(220), CByte(220), CByte(220))
        ETB_平滑断层参数4.Dock = DockStyle.Top
        ...
        ETB_平滑断层参数4.Padding = New Padding(15, 0, 15, 0)
        ETB_平滑断层参数4.Size = New Size(544, 50)
        ETB_平滑断层参数4.TabIndex = 27
        ETB_平滑断层参数4.ThumbBorderWidth = 0
        ETB_平滑断层参数4.ThumbColor = Color.MediumPurple
        ETB_平滑断层参数4.ThumbHeight = 28
        ETB_平滑断层参数4.ThumbTextDecimalPlaces = 1
        ETB_平滑断层参数4.ThumbTextMode = LakeUI.ExcellentTrackBar.ThumbTextModeEnum.Value
        ETB_平滑断层参数4.ThumbWidth = 38
        ETB_平滑断层参数4.TrackColor = Color.FromArgb(CByte(120), CByte(255), CByte(255), CByte(255))
        ETB_平滑断层参数4.TrackFillColor = Color.Transparent
        '
        ' HCL_平滑断层参数名称4
        '
        HCL_平滑断层参数名称4.AutoSize = True
        HCL_平滑断层参数名称4.AutoSizeMode = AutoSizeMode.GrowAndShrink
        HCL_平滑断层参数名称4.Dock = DockStyle.Top
        HCL_平滑断层参数名称4.Location = New Point(0, 20)
        ...
        ' ETB_平滑断层参数3
        '
        ETB_平滑断层参数3.BackColor = Color.FromArgb(CByte(20), CByte(220), CByte(220), CByte(220))
        ETB_平滑断层参数3.Dock = DockStyle.Top
        ...
        ETB_平滑断层参数3.Padding = New Padding(15, 0, 15, 0)
        ETB_平滑断层参数3.Size = New Size(544, 50)
        ETB_平滑断层参数3.TabIndex = 27
        ETB_平滑断层参数3.ThumbBorderWidth = 0
        ETB_平滑断层参数3.ThumbColor = Color.CornflowerBlue
        ETB_平滑断层参数3.ThumbHeight = 28
        ETB_平滑断层参数3.ThumbTextDecimalPlaces = 1
        ETB_平滑断层参数3.ThumbTextMode = LakeUI.ExcellentTrackBar.ThumbTextModeEnum.Value
        ETB_平滑断层参数3.ThumbWidth = 38
        ETB_平滑断层参数3.TrackColor = Color.FromArgb(CByte(120), CByte(255), CByte(255), CByte(255))
        ETB_平滑断层参数3.TrackFillColor = Color.Transparent
        '
        ' HCL_平滑断层参数名称3
        '
        HCL_平滑断层参数名称3.AutoSize = True
        HCL_平滑断层参数名称3.AutoSizeMode = AutoSizeMode.GrowAndShrink
        HCL_平滑断层参数名称3.Dock = DockStyle.Top
        HCL_平滑断层参数名称3.Location = New Point(0, 20)
        ...
        ' ETB_平滑断层参数2
        '
        ETB_平滑断层参数2.BackColor = Color.FromArgb(CByte(20), CByte(220), CByte(220), CByte(220))
        ETB_平滑断层参数2.Dock = DockStyle.Top
        ...
        ETB_平滑断层参数2.Padding = New Padding(15, 0, 15, 0)
        ETB_平滑断层参数2.Size = New Size(544, 50)
        ETB_平滑断层参数2.TabIndex = 27
        ETB_平滑断层参数2.ThumbBorderWidth = 0
        ETB_平滑断层参数2.ThumbColor = Color.OliveDrab
        ETB_平滑断层参数2.ThumbHeight = 28
        ETB_平滑断层参数2.ThumbTextDecimalPlaces = 1
        ETB_平滑断层参数2.ThumbTextMode = LakeUI.ExcellentTrackBar.ThumbTextModeEnum.Value
        ETB_平滑断层参数2.ThumbWidth = 38
        ETB_平滑断层参数2.TrackColor = Color.FromArgb(CByte(120), CByte(255), CByte(255), CByte(255))
        ETB_平滑断层参数2.TrackFillColor = Color.Transparent
        '
        ' HCL_平滑断层参数名称2
        '
        HCL_平滑断层参数名称2.AutoSize = True
        HCL_平滑断层参数名称2.AutoSizeMode = AutoSizeMode.GrowAndShrink
        HCL_平滑断层参数名称2.Dock = DockStyle.Top
        HCL_平滑断层参数名称2.Location = New Point(0, 20)
        ...
        ' ETB_平滑断层参数1
        '
        ETB_平滑断层参数1.BackColor = Color.FromArgb(CByte(20), CByte(220), CByte(220), CByte(220))
        ETB_平滑断层参数1.Dock = DockStyle.Top
        ...
        ETB_平滑断层参数1.Padding = New Padding(15, 0, 15, 0)
        ETB_平滑断层参数1.Size = New Size(544, 50)
        ETB_平滑断层参数1.TabIndex = 27
        ETB_平滑断层参数1.ThumbBorderWidth = 0
        ETB_平滑断层参数1.ThumbColor = Color.IndianRed
        ETB_平滑断层参数1.ThumbHeight = 28
        ETB_平滑断层参数1.ThumbTextDecimalPlaces = 1
        ETB_平滑断层参数1.ThumbTextMode = LakeUI.ExcellentTrackBar.ThumbTextModeEnum.Value
        ETB_平滑断层参数1.ThumbWidth = 38
        ETB_平滑断层参数1.TrackColor = Color.FromArgb(CByte(120), CByte(255), CByte(255), CByte(255))
        ETB_平滑断层参数1.TrackFillColor = Color.Transparent
        '
        ' HCL_平滑断层参数名称1
        '
        HCL_平滑断层参数名称1.AutoSize = True
        HCL_平滑断层参数名称1.AutoSizeMode = AutoSizeMode.GrowAndShrink
        HCL_平滑断层参数名称1.Dock = DockStyle.Top
        HCL_平滑断层参数名称1.Location = New Point(0, 20)
        ...
        MCB_滤镜选择.Items.Add("")
        MCB_滤镜选择.Items.Add("deband - 标准去色带")
        MCB_滤镜选择.Items.Add("deband - 强力去色带")
        MCB_滤镜选择.Items.Add("gradfun - 快速渐变平滑")
        MCB_滤镜选择.Items.Add("libplacebo - GPU 去色带加颗粒")
        ...
        ' MCK_平滑断层总开关
        '
        MCK_平滑断层总开关.AutoSize = True
        MCK_平滑断层总开关.BoxBorderRadius = 5
        MCK_平滑断层总开关.BoxBorderSize = 0
        MCK_平滑断层总开关.BoxCheckedBackColor = Color.OliveDrab
        MCK_平滑断层总开关.BoxInnerPadding = 6
        MCK_平滑断层总开关.BoxSize = 24
        MCK_平滑断层总开关.BoxTextSpacing = 10
        MCK_平滑断层总开关.BoxUncheckedBackColor = Color.FromArgb(CByte(60), CByte(220), CByte(220), CByte(220))
        MCK_平滑断层总开关.CheckMarkWidth = 3F
        MCK_平滑断层总开关.Dock = DockStyle.Top
        MCK_平滑断层总开关.Location = New Point(20, 20)
        MCK_平滑断层总开关.Name = "MCK_平滑断层总开关"
        MCK_平滑断层总开关.Size = New Size(544, 24)
        MCK_平滑断层总开关.TabIndex = 25
        MCK_平滑断层总开关.Text = "平滑断层总开关 / 勾选才会启用"
        '
        ' Form_v6_参数面板_平滑断层
        '
