...
Partial Class Form_v6_参数面板_平滑断层
    ...
    Private Sub InitializeComponent()
        ...
        MCB_平滑断层总开关 = New LakeUI.ModernCheckBox()
        ...
        ModernPanel1.Controls.Add(MCB_平滑断层总开关)
        ...
        HtmlColorLabel4.Text = "平滑断层参数名称4"
        ' 
        ' Panel3
        ' 
        ...
        HtmlColorLabel3.Text = "平滑断层参数名称3"
        ' 
        ' Panel2
        ' 
        ...
        HtmlColorLabel2.Text = "平滑断层参数名称2"
        ' 
        ' Panel1
        ' 
        ...
        HtmlColorLabel1.Text = "平滑断层参数名称1"
        ' 
        ' Panel5
        ' 
        ...
        ' MCB_平滑断层总开关
        ' 
        MCB_平滑断层总开关.AutoSize = True
        MCB_平滑断层总开关.BoxBorderRadius = 5
        MCB_平滑断层总开关.BoxBorderSize = 0
        MCB_平滑断层总开关.BoxCheckedBackColor = Color.OliveDrab
        MCB_平滑断层总开关.BoxInnerPadding = 6
        MCB_平滑断层总开关.BoxSize = 24
        MCB_平滑断层总开关.BoxTextSpacing = 10
        MCB_平滑断层总开关.BoxUncheckedBackColor = Color.FromArgb(CByte(60), CByte(220), CByte(220), CByte(220))
        MCB_平滑断层总开关.CheckMarkWidth = 3F
        MCB_平滑断层总开关.Dock = DockStyle.Top
        MCB_平滑断层总开关.Location = New Point(20, 20)
        MCB_平滑断层总开关.Name = "MCB_平滑断层总开关"
        MCB_平滑断层总开关.Size = New Size(544, 24)
        MCB_平滑断层总开关.TabIndex = 25
        MCB_平滑断层总开关.Text = "平滑断层总开关 / 勾选才会启用"
        ' 
        ' Form_v6_参数面板_平滑断层
        ' 
    ...
    Friend WithEvents MCB_平滑断层总开关 As LakeUI.ModernCheckBox
