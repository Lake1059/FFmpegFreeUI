...
Partial Class Form_v6_参数面板_胶片颗粒
    ...
    Private Sub InitializeComponent()
        ...
        ETB_胶片颗粒参数4.LabelLineColor = Color.FromArgb(CByte(120), CByte(255), CByte(255), CByte(255))
        ETB_胶片颗粒参数4.LabelLineLength = 16
        ETB_胶片颗粒参数4.Location = New Point(0, 51)
        ETB_胶片颗粒参数4.Margin = New Padding(2, 2, 2, 2)
        ETB_胶片颗粒参数4.Maximum = 10R
        ETB_胶片颗粒参数4.Name = "ETB_胶片颗粒参数4"
        ETB_胶片颗粒参数4.Padding = New Padding(15, 0, 15, 0)
        ETB_胶片颗粒参数4.Size = New Size(544, 50)
        ETB_胶片颗粒参数4.TabIndex = 27
        ETB_胶片颗粒参数4.ThumbBorderWidth = 0
        ETB_胶片颗粒参数4.ThumbColor = Color.MediumPurple
        ETB_胶片颗粒参数4.ThumbHeight = 28
        ETB_胶片颗粒参数4.ThumbTextDecimalPlaces = 1
        ETB_胶片颗粒参数4.ThumbTextMode = LakeUI.ExcellentTrackBar.ThumbTextModeEnum.Value
        ...
        ETB_胶片颗粒参数3.LabelLineColor = Color.FromArgb(CByte(120), CByte(255), CByte(255), CByte(255))
        ETB_胶片颗粒参数3.LabelLineLength = 16
        ETB_胶片颗粒参数3.Location = New Point(0, 51)
        ETB_胶片颗粒参数3.Margin = New Padding(2, 2, 2, 2)
        ETB_胶片颗粒参数3.Maximum = 10R
        ETB_胶片颗粒参数3.Name = "ETB_胶片颗粒参数3"
        ETB_胶片颗粒参数3.Padding = New Padding(15, 0, 15, 0)
        ETB_胶片颗粒参数3.Size = New Size(544, 50)
        ETB_胶片颗粒参数3.TabIndex = 27
        ETB_胶片颗粒参数3.ThumbBorderWidth = 0
        ETB_胶片颗粒参数3.ThumbColor = Color.CornflowerBlue
        ETB_胶片颗粒参数3.ThumbHeight = 28
        ETB_胶片颗粒参数3.ThumbTextDecimalPlaces = 1
        ETB_胶片颗粒参数3.ThumbTextMode = LakeUI.ExcellentTrackBar.ThumbTextModeEnum.Value
        ...
        ETB_胶片颗粒参数2.LabelLineColor = Color.FromArgb(CByte(120), CByte(255), CByte(255), CByte(255))
        ETB_胶片颗粒参数2.LabelLineLength = 16
        ETB_胶片颗粒参数2.Location = New Point(0, 51)
        ETB_胶片颗粒参数2.Margin = New Padding(2, 2, 2, 2)
        ETB_胶片颗粒参数2.Maximum = 10R
        ETB_胶片颗粒参数2.Name = "ETB_胶片颗粒参数2"
        ETB_胶片颗粒参数2.Padding = New Padding(15, 0, 15, 0)
        ETB_胶片颗粒参数2.Size = New Size(544, 50)
        ETB_胶片颗粒参数2.TabIndex = 27
        ETB_胶片颗粒参数2.ThumbBorderWidth = 0
        ETB_胶片颗粒参数2.ThumbColor = Color.OliveDrab
        ETB_胶片颗粒参数2.ThumbHeight = 28
        ETB_胶片颗粒参数2.ThumbTextDecimalPlaces = 1
        ETB_胶片颗粒参数2.ThumbTextMode = LakeUI.ExcellentTrackBar.ThumbTextModeEnum.Value
        ...
        ETB_胶片颗粒参数1.LabelLineColor = Color.FromArgb(CByte(120), CByte(255), CByte(255), CByte(255))
        ETB_胶片颗粒参数1.LabelLineLength = 16
        ETB_胶片颗粒参数1.Location = New Point(0, 51)
        ETB_胶片颗粒参数1.Margin = New Padding(2, 2, 2, 2)
        ETB_胶片颗粒参数1.Maximum = 10R
        ETB_胶片颗粒参数1.Name = "ETB_胶片颗粒参数1"
        ETB_胶片颗粒参数1.Padding = New Padding(15, 0, 15, 0)
        ETB_胶片颗粒参数1.Size = New Size(544, 50)
        ETB_胶片颗粒参数1.TabIndex = 27
        ETB_胶片颗粒参数1.ThumbBorderWidth = 0
        ETB_胶片颗粒参数1.ThumbColor = Color.IndianRed
        ETB_胶片颗粒参数1.ThumbHeight = 28
        ETB_胶片颗粒参数1.ThumbTextDecimalPlaces = 1
        ETB_胶片颗粒参数1.ThumbTextMode = LakeUI.ExcellentTrackBar.ThumbTextModeEnum.Value
        ...
        MCB_滤镜选择.Items.Add("")
        MCB_滤镜选择.Items.Add("noise - 全平面动态均匀颗粒")
        MCB_滤镜选择.Items.Add("noise - 亮度为主动态颗粒")
        MCB_滤镜选择.Items.Add("noise - 柔和平均颗粒")
        MCB_滤镜选择.Items.Add("libplacebo - 应用片源胶片颗粒元数据")
