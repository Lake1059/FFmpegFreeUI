...
Partial Class Form_v6_参数面板_插帧参数
    ...
    Private Sub InitializeComponent()
        ...
        Panel3 = New Panel()
        MCB_可变块大小的运动补偿 = New LakeUI.ModernCheckBox()
        ...
        ' Panel7
        ' 
        Panel7.Controls.Add(HtmlColorLabel4)
        ...
        HtmlColorLabel4.Location = New Point(320, 0)
        HtmlColorLabel4.Margin = New Padding(2)
        HtmlColorLabel4.Name = "HtmlColorLabel4"
        HtmlColorLabel4.Size = New Size(274, 30)
        HtmlColorLabel4.TabIndex = 2
        HtmlColorLabel4.Text = "场景变化检测强度 scd=fdiff 默认 10"
        ...
        HtmlColorLabel8.Location = New Point(160, 0)
        HtmlColorLabel8.Margin = New Padding(2)
        HtmlColorLabel8.Name = "HtmlColorLabel8"
        HtmlColorLabel8.Size = New Size(160, 30)
        HtmlColorLabel8.TabIndex = 1
        HtmlColorLabel8.Text = "搜索范围 (默认 32)"
        HtmlColorLabel8.TextAlign = LakeUI.HtmlColorLabel.TextAlignEnum.BottomLeft
        ' 
        ' HtmlColorLabel10
        ' 
        ...
        HtmlColorLabel10.Location = New Point(0, 0)
        HtmlColorLabel10.Margin = New Padding(2)
        HtmlColorLabel10.Name = "HtmlColorLabel10"
        HtmlColorLabel10.Size = New Size(160, 30)
        HtmlColorLabel10.TabIndex = 0
        HtmlColorLabel10.Text = "块大小 (默认 16)"
        ...
        HtmlColorLabel2.Location = New Point(20, 320)
        HtmlColorLabel2.Margin = New Padding(2)
        HtmlColorLabel2.Name = "HtmlColorLabel2"
        HtmlColorLabel2.Padding = New Padding(0, 20, 0, 0)
        HtmlColorLabel2.Size = New Size(594, 45)
        HtmlColorLabel2.TabIndex = 29
        HtmlColorLabel2.Text = "<span style=""font-size:13; color:Silver"">识别设置</span>   值越大计算需求越多越稳定"
        ' 
        ' Panel3
        ' 
        Panel3.Controls.Add(MCB_可变块大小的运动补偿)
        ...
        ' MCB_可变块大小的运动补偿
        ' 
        MCB_可变块大小的运动补偿.AutoSize = True
        MCB_可变块大小的运动补偿.BoxBorderSize = 0
        MCB_可变块大小的运动补偿.BoxCheckedBackColor = Color.OliveDrab
        MCB_可变块大小的运动补偿.BoxInnerPadding = 5
        MCB_可变块大小的运动补偿.BoxSize = 20
        MCB_可变块大小的运动补偿.BoxTextSpacing = 10
        MCB_可变块大小的运动补偿.BoxUncheckedBackColor = Color.FromArgb(CByte(60), CByte(220), CByte(220), CByte(220))
        MCB_可变块大小的运动补偿.Dock = DockStyle.Fill
        MCB_可变块大小的运动补偿.Location = New Point(150, 10)
        MCB_可变块大小的运动补偿.Name = "MCB_可变块大小的运动补偿"
        MCB_可变块大小的运动补偿.Padding = New Padding(10, 0, 0, 0)
        MCB_可变块大小的运动补偿.Size = New Size(444, 32)
        MCB_可变块大小的运动补偿.TabIndex = 24
        MCB_可变块大小的运动补偿.Text = "可变块大小的运动补偿 vsbmc=1"
        ' 
        ' MCB_运动补偿模式
        ' 
        ...
        HtmlColorLabel7.Size = New Size(160, 30)
        HtmlColorLabel7.TabIndex = 2
        HtmlColorLabel7.Text = "运动估计算法"
        ...
        HtmlColorLabel5.Size = New Size(160, 30)
        HtmlColorLabel5.TabIndex = 0
        HtmlColorLabel5.Text = "插帧模式"
        ...
        HtmlColorLabel3.Size = New Size(594, 45)
        HtmlColorLabel3.TabIndex = 26
        HtmlColorLabel3.Text = "<span style=""font-size:13; color:Silver"">算法设置</span>   推荐的最佳质量：运动补偿插值 + 加权 obmc"
        ' 
        ' Panel2
        ' 
        ...
        HtmlColorLabel1.Size = New Size(594, 45)
        HtmlColorLabel1.TabIndex = 24
        HtmlColorLabel1.Text = "<span style=""font-size:13; color:Silver"">目标帧率</span>   然后就不要在其他地方设置帧率了"
        ' 
        ' MCB_插帧总开关
        ' 
        ...
        MCB_插帧总开关.Size = New Size(594, 24)
        MCB_插帧总开关.TabIndex = 23
        MCB_插帧总开关.Text = "插帧总开关 / 勾选才会使用 / 建议考虑 AI 软件，如 SVP、TopazAI"
        ' 
        ' Form_v6_参数面板_插帧参数
        ' 
    ...
    Friend WithEvents MCB_可变块大小的运动补偿 As LakeUI.ModernCheckBox
