...
Public Class Entry
    ...
    End Sub
    Public Shared Sub AddMissionToQueueWithArgs()
        '将任务添加到编码队列中
        '在你的自定义控件中调用这个来添加任务
        HostCall_AddMissionToQueueWithArgs.Invoke("给 ffmpeg 的参数，不要以 ffmpeg 开始", "在编码队列里显示的文件名，也可以用来显示其他信息", "输出文件的路径在哪，用于编码队列中的定位输出功能", "")
    End Sub
